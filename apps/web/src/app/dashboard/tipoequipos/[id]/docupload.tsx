...
export default function TipoEquipoDocUpload({ eqTypeId, orgId, doctypes } : { eqTypeId: string, orgId: string, doctypes: InferSelectModel<typeof schema.documentTypes>[] }) {
  ...
  const doUpload = async () => {
    ...
    if (docType === null) {
      const newDT = await docTypeMut.mutateAsync({
        correlatedWith: DocCorrelatedWith.EquipmentType,
